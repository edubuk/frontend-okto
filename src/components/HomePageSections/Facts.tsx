...
<div className="grid grid-cols-2">
    ...
    <div className='relative'>
      <div className='absolute flex top-[20%] -ml-[-2%] sm:-ml-[30%] justify-center items-center gap-6'>
      ...
      <div className='absolute flex top-[45%] -ml-[-5%]  sm:-ml-[30%] justify-center items-center gap-6'>
      <div className='flex justify-center items-start flex-col'>
      ...
      <div className='absolute top-[75%] -ml-[-4%] sm:-ml-[30%] flex justify-center items-center gap-6'>
      <div className='flex justify-center items-start flex-col'>
